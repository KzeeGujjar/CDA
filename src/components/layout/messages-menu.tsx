    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          ...
          {unreadCount > 0 && <span aria-hidden="true" className="absolute top-1 end-1 flex size-2 rounded-full bg-accent" />}
        </Button>
      </DropdownMenuTrigger>
      <DropdownMenuContent align="end" className="w-80">
        ...
        <div className="flex max-h-80 flex-col gap-0.5 overflow-y-auto">
          {messages.map((m) => (
            ...
            >
              <span className="mt-0.5 size-1.5 shrink-0 rounded-full" data-unread={m.unread}
