...
import { addCustomerNote, getCustomerNotes } from "@/services/customers";
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-col gap-2">
        <Textarea placeholder={t("customers.addNote")} rows={2} value={body} onChange={(e) => setBody(e.target.value)} />
